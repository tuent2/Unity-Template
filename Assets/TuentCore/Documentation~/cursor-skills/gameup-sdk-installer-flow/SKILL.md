...
description: Handles Tuent SDK installer and updater workflow in Unity Editor with safe package checks and post-install setup. Use when editing GameUpPackageInstaller, dependency windows, or installer-related menu actions.
disable-model-invocation: true
---

# Tuent SDK Installer Flow
