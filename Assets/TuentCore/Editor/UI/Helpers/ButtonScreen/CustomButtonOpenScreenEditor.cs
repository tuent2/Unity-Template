...
{
    [CustomEditor(typeof(CustomButtonOpenScreen))]
    public class CustomButtonOpenScreenEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Ping ScreenData asset"))
            {
                ...
                {
                    TLogger.Warning("CustomButtonOpenScreenEditor", $"Resources.Load failed: `{ScreenDataResourcePath}`.");
                }
            }
