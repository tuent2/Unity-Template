...
namespace Tuent.Core.UI
{
    ...
    ///     The index of the cell view snapped on (this may be different than the data index in case of
    ///     looping)
    /// </param>
    ...
    public class EnhancedScroller : MonoBehaviour
    {
        ...
        public float ScrollSize
        {
            ...
            {
                if (scrollDirection == ScrollDirectionEnum.Vertical)
                    return Mathf.Max(Container.rect.height - _scrollRectTransform.rect.height, 0);
                return Mathf.Max(Container.rect.width - _scrollRectTransform.rect.width, 0);
            }
        }
        ...
        public float LinearVelocity
        {
            get =>
                ...
                scrollDirection == ScrollDirectionEnum.Vertical ? _scrollRect.velocity.y : _scrollRect.velocity.x;
            set
            {
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScrollerCellView cellPrefab)
        {
            ...
            if (cellView == null)
            {
                ...
                if (cellViewInstantiated != null) cellViewInstantiated(this, cellView);
            }
            else
            {
                // call the reused callback
                if (cellViewReused != null) cellViewReused(this, cellView);
            }
        ...
        ///     The percentage of the scroller to start at between 0 and 1, 0 being the start of the
        ///     scroller
        /// </param>
        public void ReloadData(float scrollPositionFactor = 0)
        {
            ...
            if (_scrollRect == null || _scrollRectTransform == null || Container == null)
            {
                _scrollPosition = 0f;
                return;
            }
        ...
        {
            for (var i = 0; i < _activeCellViews.Count; i++) _activeCellViews[i].RefreshCellView();
        }
        ...
        {
            for (var i = 0; i < _activeCellViews.Count; i++) DestroyImmediate(_activeCellViews[i].gameObject);
        ...
        {
            for (var i = 0; i < _recycledCellViews.Count; i++) DestroyImmediate(_recycledCellViews[i].gameObject);
        ...
        )
        {
            ...
            if (scrollerOffset == 1f) cellOffsetPosition += padding.bottom;
            ...
            if (loop)
            {
                ...
                if (useSpacing) newScrollPosition -= spacing;
            }
            else
            {
        ...
        public float GetScrollPositionForCellViewIndex(int cellViewIndex, CellViewPositionEnum insertPosition)
        {
            ...
            if (cellViewIndex == 0 && insertPosition == CellViewPositionEnum.Before) return 0;
        ...
        /// </summary>
        private readonly SmallList<EnhancedScrollerCellView> _recycledCellViews = new();
        ...
        /// </summary>
        private readonly SmallList<float> _cellViewSizeArray = new();
        ...
        /// </summary>
        private readonly SmallList<float> _cellViewOffsetArray = new();
        ...
        /// </summary>
        private readonly SmallList<EnhancedScrollerCellView> _activeCellViews = new();
        ...
        public void _Resize(bool keepPosition)
        {
            ...
            if (scrollDirection == ScrollDirectionEnum.Vertical)
                ...
                Container.sizeDelta = new Vector2(_cellViewOffsetArray.Last() + padding.left + padding.right,
        ...
        private void _ResetVisibleCellViews()
        {
            ...
            if (remainingCellIndices.Count == 0)
            {
                ...
                for (i = startIndex; i <= endIndex; i++) _AddCellView(i, ListPositionEnum.Last);
            }
            else
            {
        ...
        private void Awake()
        {
            ...
            if (_scrollRect.content != null) DestroyImmediate(_scrollRect.content.gameObject);
        ...
        private void OnValidate()
        {
            ...
            if (_initialized && spacing != _layoutGroup.spacing) _updateSpacing = true;
        }
                ...
                while (_tweenTimeLeft < time)
                {
                    switch (tweenType)
                    {
                        ...
                        case TweenType.easeInOutQuad:
                            newPosition = easeInOutQuad(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInCubic: newPosition = easeInCubic(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeOutCubic:
                            newPosition = easeOutCubic(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInOutCubic:
                            newPosition = easeInOutCubic(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInQuart: newPosition = easeInQuart(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeOutQuart:
                            newPosition = easeOutQuart(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInOutQuart:
                            newPosition = easeInOutQuart(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInQuint: newPosition = easeInQuint(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeOutQuint:
                            newPosition = easeOutQuint(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInOutQuint:
                            newPosition = easeInOutQuint(start, end, _tweenTimeLeft / time); break;
                        ...
                        case TweenType.easeInOutSine:
                            newPosition = easeInOutSine(start, end, _tweenTimeLeft / time); break;
                        ...
                        case TweenType.easeInOutExpo:
                            newPosition = easeInOutExpo(start, end, _tweenTimeLeft / time); break;
                        ...
                        case TweenType.easeInOutCirc:
                            newPosition = easeInOutCirc(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInBounce:
                            newPosition = easeInBounce(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeOutBounce:
                            newPosition = easeOutBounce(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInOutBounce:
                            newPosition = easeInOutBounce(start, end, _tweenTimeLeft / time); break;
                        ...
                        case TweenType.easeInOutBack:
                            newPosition = easeInOutBack(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInElastic:
                            newPosition = easeInElastic(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeOutElastic:
                            newPosition = easeOutElastic(start, end, _tweenTimeLeft / time); break;
                        case TweenType.easeInOutElastic:
                            newPosition = easeInOutElastic(start, end, _tweenTimeLeft / time); break;
                    }
