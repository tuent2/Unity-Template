...
namespace Tuent.Core.UI
{
    public class ChangeSpriteResizeTweenNav2 : BaseSelectView
    {
        ...
        private void PlayTween(bool isSelected)
        {
            ...
            var targetY = isSelected ? posSelect.anchoredPosition : posNotSelect.anchoredPosition;
            ...
            _sequence
                ...
                .Join(targetIconImage.rectTransform.DOAnchorPos(targetY, 0.25f).SetEase(Ease.OutCubic))
